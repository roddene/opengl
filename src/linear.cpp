...
mat4 create_model_transform(float angle, vec3 translation)
{
...
mat4 create_rotation_transform(float angle)
{
...
vec3 normalize(vec3 v)
{
    ...
    u.entries[0] = v.entries[0] / mag;
    u.entries[1] = v.entries[1] / mag;
    u.entries[2] = v.entries[2] / mag;
